        ...
        function() {
            ...
            t.position = {
                    ...
                    return b = s(y), y[0].preventDefault && (n.at = "left top"), g = b.width, m = b.height, _ = b.offset, v = t.extend({}, _), t.each(["my", "at"], function() {
                        ...
                        "right" === n.my[0] ? T.left -= u : "center" === n.my[0] && (T.left -= u / 2), "bottom" === n.my[1] ? T.top -= d : "center" === n.my[1] && (T.top -= d / 2), T.left += P[0], T.top += P[1], o || (T.left = l(T.left), T.top = l(T.top)), s = {
                            marginLeft: f,
                            marginTop: b
    ...
    t.effects = {
        ...
        function() {
            ...
            t.extend(t.effects, {
                ...
                restore: function(t, e) {
                    var i, s;
                    for (s = 0; e.length > s; s++) null !== e[s] && (i = t.data(a + e[s]), void 0 === i && (i = ""), t.css(e[s], i))
                },
        ...
        function() {
            ...
            a.parent().is(".ui-effects-wrapper") ? t.effects.save(a.parent(), h) : t.effects.save(a, h), a.show(), s = t.effects.createWrapper(a).css({
                overflow: "hidden"
            }), n = s[p](), o = parseFloat(s.css(f)) || 0, m[p] = _ ? n : 0, g || (a.css(d ? "bottom" : "right", 0).css(d ? "top" : "left", "auto").css({
                position: "absolute"
            }), m[f] = _ ? o : n + o), _ && (s.css(p, 0), g || s.css(f, o + n)), s.animate(m, {
                duration: e.duration,
                easing: e.easing,
                queue: !1,
                complete: function() {
